...
<Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-white hover
focus
focus
focus
focus
...
className="text-white p-2 rounded-md hover
focus
focus
focus
focus
...
<button
type="button"
className="ml-2 rounded-full p-1 text-white hover
focus
focus
focus
focus
...
<div>
<Menu.Button className="flex rounded-full text-sm focus
focus
hover
focus
focus
...
<Transition
                 ...
                 >
<Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus
">
<Menu.Item>
{({ active }) => (
<button
