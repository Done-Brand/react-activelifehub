...
export default function Login() {
  ...
  const authenticateUser = async () => {
    ...
    loginData.append("email", loginState.email);
    loginData.append("password", loginState.password);
    loginData.append("submit", "submit"); // Add the submit field

    console.log("Sending login data:", loginData.toString());

    try {
      const response = await fetch(
        "http://localhost/react-activelifehub/php-app/login.php",
        {
          method: "POST",
          headers: {
