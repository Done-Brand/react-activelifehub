  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <div
          className="relative max-w-md mx-auto pt-20 flow-root bg-cover bg-center border-4 border-white rounded-lg shadow-lg"
          style={{ backgroundImage: `url(${MapImage})` }}
        >
          <div className="absolute inset-0 bg-white bg-opacity-80"></div>{" "}
          {/* Add overlay for better readability */}
          <ul role="list" className="relative -mb-8 z-10 p-4">
            <li>
